...
if (is_product()) {
  ...
  function strip_body_classes( $classes ) {
    ...
    foreach($classes as $class) {
      if ($class === 'admin-bar') {
        array_splice($classes,$i);
      } else if ($class === 'wp-custom-logo') {
        array_splice($classes, $i);
      } else if ($class === 'stretched') {
        array_splice($classes, $i);
      } else if ($class === 'helvetica-neue-websave') {
        array_splice($classes, $i);
      } else if ($class === '_helvetica_neue') {
        array_splice($classes, $i);
      } else if ($class === 'no_sidebar_border') {
        array_splice($classes, $i);
      }
      $i++;
    }
