	...
	public function admin_scripts() {
		...
		if ( in_array( $screen_id, array( 'product', 'edit-product' ) ) ) {
			...
			$params = array(
				...
				'i18n_link_all_variations'            => esc_js( sprintf( __( 'Are you sure you want to link all variations? This will custom-t a new variation for each and every possible combination of variation attributes (max %d per run).', 'woocommerce' ), defined( 'WC_MAX_LINKED_VARIATIONS' ) ? WC_MAX_LINKED_VARIATIONS : 50 ) ),
