...
function walqv_hook_quickview_link(){
  global $post;
  echo '<div class="wpb_wl_preview_area"><a class="ajax-popup-link wpb_wl_preview open-popup-link walqv_product_preview" href="'.get_permalink($post->ID).'" data-effect="mfp-zoom-in"  data-id="'.get_the_id().'"><i class="fa fa-search fa-2x"></i></a></div>';
}
